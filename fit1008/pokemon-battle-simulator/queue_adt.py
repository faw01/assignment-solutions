...
class CircularQueue(Queue[T]):
    ...
    def __init__(self,max_capacity:int) -> None:
        ...
        self.max_cap = max(self.MIN_CAPACITY,max_capacity)


    # Additional magic (dunder) methods - added by Dhiren (to do special battle mode 1)
    ...
    def reverse(self, length) -> None:
        self.array = self.array[length - 1::-1]
